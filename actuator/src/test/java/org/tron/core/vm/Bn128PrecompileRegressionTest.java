...
public class Bn128PrecompileRegressionTest {
  ...
  @Parameterized.Parameters(name = "optimized={0}")
  public static Collection<Object[]> implementations() {
    return Arrays.asList(new Object[][]{{0L}, {1L}});
  }

  private final long optimized;
  private boolean previousOptimization;

  public Bn128PrecompileRegressionTest(long optimized) {
    this.optimized = optimized;
  }

  @Before
  public void selectImplementation() {
    previousOptimization = VMConfig.allowOptimizeTvm();
    VMConfig.initAllowOptimizeTvm(optimized);
  }

  @After
  public void restoreImplementation() {
    VMConfig.initAllowOptimizeTvm(previousOptimization ? 1L : 0L);
  }

  @Test
  public void goEthereumKnownAnswerVectors() throws Exception {
    // JSON vectors copied unchanged from ethereum/go-ethereum commit
    // 64006a1e1c6281ad570d80129493d602fe081407, core/vm/testdata/precompiles/.
    ...
    for (int i = 0; i < files.length; i++) {
      contracts[i].setVmShouldEndInUs(Long.MAX_VALUE);
  ...
  public void multiplicationAcceptsFullWidthScalars() {
    ...
    mul.setVmShouldEndInUs(Long.MAX_VALUE);
  ...
  public void pairingPreservesReturnBytesAndValidation() {
    ...
    precompile.setVmShouldEndInUs(Long.MAX_VALUE);
  ...
  public void additionAndMultiplicationStillAgreeWithPairingFixtures() {
    ...
    PrecompiledContracts.BN128Multiplication mul = new PrecompiledContracts.BN128Multiplication();
    add.setVmShouldEndInUs(Long.MAX_VALUE);
    mul.setVmShouldEndInUs(Long.MAX_VALUE);
