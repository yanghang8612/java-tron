...
public class EventConfig {
  ...
  // === JustLend Feature ===
  // These legacy nested keys are read manually in fromConfig().
  @Setter(lombok.AccessLevel.NONE)
  ...
  public static EventConfig fromConfig(Config config) {
    ...
    String justlendKey = "justlend";
    // Remove keys that cannot be bound automatically; bind them manually below.
    Config bindable = section.withoutPath(nativeKey).withoutPath(topicsKey)
        .withoutPath(justlendKey);
